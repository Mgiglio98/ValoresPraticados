...
df_filtrado_view = df_filtrado_view.rename(columns={"INSUMOCDG": "Código do Insumo","INSUMO": "Insumo","VALORESPRATICADOS": "Preço de Compra","UNIDADE": "Unidade","DATACOMPRA": "Data da Compra","ESTADO": "Estado","FORNECEDOR": "Fornecedor"})
st.dataframe(df_filtrado_view.head(50), hide_index=True)
